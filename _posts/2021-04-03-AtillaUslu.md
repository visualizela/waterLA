...
---
layout: post
title: "Road Map of the Colorado River Aqueduct and General Informations on the plans"
timelinedate: 2021-04-01
categories: ["category 4"]
author: "Atilla Uslu"
lat: 33.68596406406717
lng: -115.93475168478827
headertitle: "Road Map of the Colorado River Aqueduct"
...
![Imagetitle](images/ColoradoRiverAqueductRM2)
...
![Image title](images/https://d30821mshh5k7n.cloudfront.net/2c05e0a9-1592-4637-ac2f-928e883e64c6/full/1024,/0/default.jpg)
   {:.image} <-- this tag is needed for image formatting and for Lightbox feature -->
The image is a less detailed version of map of the Colorado River Aqueduct, where it is easier to see the path of the water directly to LA. The documnet is from 
   {:.caption} <-- this tag is needed for caption formatting and for Lightbox feature -->
...
![Imagetitle](images/Pumping_station_along_Colorado_Aqueduct.jpg)
   {:.image} <-- this tag is needed for image formatting and for Lightbox feature -->
The image is photo of the pumping statation used in the Colorado River Aqueduct Project. It is from the Los Angeles Public Library, tps://calisphere.org/item/24dc146341823d4cd79e8ae1fe110011/ . 
   {:.caption} <-- this tag is needed for caption formatting and for Lightbox feature -->
